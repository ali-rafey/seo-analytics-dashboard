/**
 * ISO 3166-1 alpha-2 → numeric mapping. GA4's `countryId` dimension returns
 * alpha-2 (e.g. "US"); the world-atlas TopoJSON used by react-simple-maps
 * keys countries by ISO numeric (e.g. "840"). This table bridges them.
 *
 * Source: https://en.wikipedia.org/wiki/ISO_3166-1_numeric (deduped, 2024).
 */
...
export function alpha2ToNumeric(code: string | null | undefined): string | null {
  if (!code) return null;
